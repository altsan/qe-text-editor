 ...
 * (Note: we keep the tab and CR/LF characters as control codes.)
 */
...
// 858: Same as 850 but with Euro sign instead of dotless-i
...
// 862: IBM Hebrew - technically this is codepage 867 but on OS/2 (and DOS?) it's 862
{ "IBM-862", { "cp862", "csPC862LatinHebrew", "IBM-867", 0 }, 2013,
  { 0x2302,
